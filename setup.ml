...
(* OASIS_START *)
(* DO NOT EDIT (digest: 2fd27d3426bf5bc61e37d306640581af) *)
(*
...
# 59 "/home/dim/sources/oasis/src/oasis/PropList.ml"
  end
...
# 21 "/home/dim/sources/oasis/src/base/BaseFilePath.ml"
...
# 21 "/home/dim/sources/oasis/src/base/BaseExec.ml"
...
# 21 "/home/dim/sources/oasis/src/base/BaseDev.ml"
...
let setup_t =
  {
     ...
     test = [];
     doc = [("estring-api", OCamlbuildDocPlugin.doc_build "./")];
     install = InternalInstallPlugin.install;
     uninstall = InternalInstallPlugin.uninstall;
     clean = [OCamlbuildPlugin.clean];
     clean_test = [];
     clean_doc = [("estring-api", OCamlbuildDocPlugin.doc_clean "./")];
     distclean = [];
     distclean_test = [];
     distclean_doc = [];
     package =
       {
          ...
          homepage = Some "http://estring.forge.ocamlcore.org/";
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Pa_estring"];
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "estring";
               ...
               SrcRepo
                 ({
                     ...
                     },
                   {
                      src_repo_type = Darcs;
                      src_repo_location =
                        "http://darcs.ocamlcore.org/repos/estring";
                      src_repo_browser =
                        Some
                          "http://darcs.ocamlcore.org/cgi-bin/darcsweb.cgi?r=estring;a=summary";
               ...
               Doc
                 ({
                     ...
                     },
                   {
                      ...
                      doc_title = "API reference for Estring";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
               ...
               Executable
                 ({
                     ...
                     },
                   {
                      ...
                      bs_path = "sample";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "estring"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
